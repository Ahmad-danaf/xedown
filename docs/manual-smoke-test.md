...
| 112 | **Restore defaults…**, then **Restore** | All thirteen preferences return to their defaults and every preview follows |
...
| 122 | *Preferences → Plugins*, select **Xedown** | The version reads **1.0.0** |
